...
const { logindata, cartdata, addressdata } = require("../controller/loginController")
...
router.post("/addUser",
    ...
    (req, res) => {
        ...
        addressdata({user_email: req.body.email, address: "[]"})
        cartdata({ user_email: req.body.email, cart_value: "{}" })
