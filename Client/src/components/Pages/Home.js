            ...
            <div id="carouselExampleControls" className="carousel slide mt-3" data-bs-ride="carousel">
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src="media/1.jpg" height="400px" className="d-block w-100" alt="..." />
                    </div>
                    <div className="carousel-item">
                        <img src="media/2.jpg" height="400px" className="d-block w-100" alt="..." />
                    </div>
                    <div className="carousel-item">
                        <img src="media/3.jpg" height="400px" className="d-block w-100" alt="..." />
                    </div>
                </div>
