...
export default function ProductDetail() {
    ...
    const data = Products.filter(product => product._id === param.id);
    const addToCart = (id) => {
        ...
        <>
            <div style={{ width: "90%" }} className="m-auto row">
                <div className="col-md-5 col-sm-12 m-auto text-center">
                    <img src={data[0]._id !== undefined ? data[0].product_image[0].base64 : ""} height="300px" alt="loading..." />
                    <div>
                ...
                <div className="col-md-7 col-sm-12 ">
                    <h2>{data[0]._id !== undefined ? data[0].product_name : ""}</h2>
                    <p><span className="productPage-subheading">Rating:</span> <span style={{ backgroundColor: "yellow", fontSize: "22px", fontWeight: "bold", padding: "5px" }} >{data[0]._id !== undefined ? data[0].product_rating : ""}</span></p>
                    <hr />
                    <p><span className="productPage-subheading">Price:</span><span style={{ color: "green", fontSize: "22px", fontWeight: "bold" }}> ${data[0]._id !== undefined ? data[0].product_cost : ""}</span></p>
                    <p ><span className="productPage-subheading">Color:</span><span style={{ color: data[0]._id !== undefined ? data[0].color_id.color_code : '', backgroundColor: data[0]._id !== undefined ? data[0].color_id.color_code : '', fontSize: "22px", padding: "5px" }}>color</span></p><br />
