        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                <div className="container-fluid">
                    <Link className="navbar-brand" style={{ fontSize: "30px", padding: "0px 10px 0px 10px" }} to="/">Neo<span style={{ color: "red" }}>Store</span></Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link active" style={{ fontSize: "20px" }} aria-current="page" to="/productpage">Product</Link>
                            </li>
                            <li className="nav-item">
                                {isLoggedIn ?
                                    <Link className="nav-link active" style={{ fontSize: "20px" }} aria-current="page" to="order">Order</Link>
                                    :
                                    <Link className="nav-link active" style={{ fontSize: "20px" }} aria-current="page" to="/login">Order</Link>
                                }
                            </li>
                        </ul>
